...
if ModUtil ~= nil then
	...
	OlympusColor.HephaestusVoice = { 204, 26, 51, 255 }
	OlympusColor.HephaestusDamageLight = { 225, 22, 53, 255 }
	OlympusColor.HephaestusDamage = { 204, 26, 51, 255 }
	--EnemyUpgradeData
	...
	--table.insert(OlympusWeaponSets.ExpireProjectileExcludeProjectileNames, "HephaestusProjectile")
	-- GlobalVoiceLines
	...
	--table.insert(OlympusLootData.ArtemisUpgrade.LinkedUpgrades.ArtemisAmmoExitTrait.OneOf, "HephaestusRangedTrait")
	-- Hephaestus
	...
	OlympusLootData.ZeusUpgrade.FreePassVoiceLines = {
		ZeusFreePass01 =
		{
			...
			{ Cue = "/VO/Zeus_0262",
				...
				StartSound = "/Leftovers/World Sounds/MapZoomInShort", UseEventEndSound = true,
				Text = "I am the strongest of my siblings, Zagreus. Yet, you picked Hephaestus over me. Well, she's very kind, I must admit. I suppose I'll show you the same kindess... this time." },
		},
	}
	...
	OlympusLootData.AthenaUpgrade.FreePassVoiceLines = {
		AthenaFreePass01 =
		{
			...
			{ Cue = "/VO/Athena_0252",
				PreLineFunctionName = "BoonInteractPresentation", PreLineWait = 1.0,
				StartSound = "/Leftovers/World Sounds/MapZoomInShort", UseEventEndSound = true,
				Text = "You picked Lady Hephaestus, I see. A strategic meanuver. In turn, I shall strategically spare you the fight this time. May you use it in your favor." },
		},
	}
	OlympusLootData.AresUpgrade.FreePassVoiceLines = {
		AresFreePass01 =
		{
			...
			{ Cue = "/VO/Ares_0252",
				PreLineFunctionName = "BoonInteractPresentation", PreLineWait = 1.0,
				StartSound = "/Leftovers/World Sounds/MapZoomInShort", UseEventEndSound = true,
				Text = "My kin... I do not appreciate this slight. However, since you picked the Lady Hephaestus, and she has personally beseeched me to find it in my heart to forgive such disrespect, I suppose I shall give you a pass this time. But mark my word, this will happen only once." },
		},
	}
	...
	OlympusLootData.ArtemisUpgrade.FreePassVoiceLines = {
		ArtemisFreePass01 =
		{
			...
			{ Cue = "/VO/Artemis_0262",
				PreLineFunctionName = "BoonInteractPresentation", PreLineWait = 1.0,
				StartSound = "/Leftovers/World Sounds/MapZoomInShort", UseEventEndSound = true,
				Text = "Look, I also appreciate Hephaestus, but that's no reason not to pick me. I mean... {#DialogueItalicFormat}Huh{#PreviousFormat} alright, I'll let it go this time. Don't get used to it." },
		},
	}
	OlympusLootData.DionysusUpgrade.FreePassVoiceLines = {
		DionysusFreePass01 =
		{
			...
			{ Cue = "/VO/Dionysus_0242",
				PreLineFunctionName = "BoonInteractPresentation", PreLineWait = 1.0,
				StartSound = "/Leftovers/World Sounds/MapZoomInShort", UseEventEndSound = true,
				Text = "{#DialogueItalicFormat}Ohh{#PreviousFormat}, Zag, you should always pick me. Wait... You picked Hephaestus? Nevermind, she deserves this one after all she's done for me. I'll even pitch this in." },
		},
	}
	...
	-- Duo PickupLines
	OlympusLootData.ZeusUpgrade.DuoPickupTextLineSets.ZeusWithHephaestus01 = {
		Name = "ZeusWithHephaestus01",
		PlayOnce = true,
		PreEventFunctionName = "BoonInteractPresentation", PreEventFunctionArgs = { PickupWait = 1.0, },
		...
		{ Cue = "/VO/Hephaestus_0049",
			...
			Speaker = "NPC_Hephaestus_01", Portrait = "Portrait_Hephaestus_Default_01",
			Text = "Sparks become fire, and Zagreus needs the firepower to join us. We must show him what he means to us." },
	}
	OlympusLootData.PoseidonUpgrade.DuoPickupTextLineSets.PoseidonWithHephaestus01 = {
		Name = "PoseidonWithHephaestus01",
		PlayOnce = true,
		PreEventFunctionName = "BoonInteractPresentation", PreEventFunctionArgs = { PickupWait = 1.0, },
	...
	OlympusLootData.AthenaUpgrade.DuoPickupTextLineSets.AthenaWithHephaestus01 = {
		Name = "AthenaWithHephaestus01",
		PlayOnce = true,
		PreEventFunctionName = "BoonInteractPresentation", PreEventFunctionArgs = { PickupWait = 1.0, },
		HasTraitNameInRoom = "MoreTrapDamageTrait",
		{ Cue = "/VO/Athena_0251",
			StartSound = "/Leftovers/World Sounds/MapZoomInShort",
			Text = "Lady Hephaestus. Make sure the fire you give to Zagreus doesn't burn him. That would be very conterproductive to our cause. I can only shield him so much." },
		{ Cue = "/VO/Hephaestus_0051",
			PortraitExitWait = 0.35,
			PreLineFunctionName = "BoonInteractPresentation", PreLineWait = 0.5,
			StartSound = "/SFX/BurnDamage",
	...
	OlympusLootData.AresUpgrade.DuoPickupTextLineSets.AresWithHephaestus01 = {
		Name = "AresWithHephaestus01",
		PlayOnce = true,
		PreEventFunctionName = "BoonInteractPresentation", PreEventFunctionArgs = { PickupWait = 1.0, },
		HasTraitNameInRoom = "FoesNumberDamageTrait",
		{ Cue = "/VO/Ares_0251",
			StartSound = "/Leftovers/World Sounds/MapZoomInShort",
			Text = "Lady Hephaestus, are you going to let him fight with hugs and kisses? I think we can agree to give him something more." },
		{ Cue = "/VO/Hephaestus_0052",
			PortraitExitWait = 0.35,
			PreLineFunctionName = "BoonInteractPresentation", PreLineWait = 0.5,
			StartSound = "/SFX/BurnDamage",
	...
	OlympusLootData.AphroditeUpgrade.DuoPickupTextLineSets.AphroditeWithHephaestus01 = {
		Name = "AphroditeWithHephaestus01",
		PlayOnce = true,
		PreEventFunctionName = "BoonInteractPresentation", PreEventFunctionArgs = { PickupWait = 1.0, },
		HasTraitNameInRoom = "FreeHealthTrait",
		{ Cue = "/VO/Aphrodite_0241",
			StartSound = "/Leftovers/World Sounds/MapZoomInShort",
			Text = "Oh, Lady Hephaestus. You are positively smoking hot, as always. I can't believe you've never taken up with any suitors! You don't know what you are missing." },
		{ Cue = "/VO/Hephaestus_0053",
			PortraitExitWait = 0.35,
			PreLineFunctionName = "BoonInteractPresentation", PreLineWait = 0.5,
			StartSound = "/SFX/BurnDamage",
	...
	OlympusLootData.ArtemisUpgrade.DuoPickupTextLineSets.ArtemisWithHephaestus01 = {
		Name = "ArtemisWithHephaestus01",
		PlayOnce = true,
		PreEventFunctionName = "BoonInteractPresentation", PreEventFunctionArgs = { PickupWait = 1.0, },
		HasTraitNameInRoom = "ExplosionTrait",
		{ Cue = "/VO/Artemis_0261",
			StartSound = "/Leftovers/World Sounds/MapZoomInShort",
			Text = "Lady Hephaestus, could you... give me the recipe once again for the smoky boar I made from the spoils of my hunt the other day? I'd like to hunt another, I think." },
		{ Cue = "/VO/Hephaestus_0054",
			PortraitExitWait = 0.35,
			PreLineFunctionName = "BoonInteractPresentation", PreLineWait = 0.5,
			StartSound = "/SFX/BurnDamage",
	...
	OlympusLootData.DionysusUpgrade.DuoPickupTextLineSets.DionysusWithHephaestus01 = {
		Name = "DionysusWithHephaestus01",
		PlayOnce = true,
		PreEventFunctionName = "BoonInteractPresentation", PreEventFunctionArgs = { PickupWait = 1.0, },
		HasTraitNameInRoom = "FullHealBossTrait",
		{ Cue = "/VO/Dionysus_0241",
			StartSound = "/Leftovers/World Sounds/MapZoomInShort",
			Text = "Oh hey, Hephaestus. I know I seem to party a lot, but I swear I am doing my part as an Olympian. You can ask the others." },
		{ Cue = "/VO/Hephaestus_0055",
			PortraitExitWait = 0.35,
			PreLineFunctionName = "BoonInteractPresentation", PreLineWait = 0.5,
			StartSound = "/SFX/BurnDamage",
	...
	OlympusLootData.DemeterUpgrade.DuoPickupTextLineSets.DemeterWithHephaestus01 = {
		Name = "DemeterWithHephaestus01",
		PlayOnce = true,
		PreEventFunctionName = "BoonInteractPresentation", PreEventFunctionArgs = { PickupWait = 1.0, },
	...
	OlympusLootData.AphroditeUpgrade.LinkedUpgrades.FreeHealthTrait =
	{
		OneFromEachSet =
		{
			{ "HephaestusWeaponTrait", "HephaestusSecondaryTrait", "HephaestusDashTrait", "HephaestusRangedTrait" },
	...
	OlympusLootData.AthenaUpgrade.LinkedUpgrades.MoreTrapDamageTrait =
	{
		OneFromEachSet =
		{
			{ "HephaestusRangedTrait", "HephaestusRevengeTrait", "LavaDeathTrait" },
	...
	OlympusLootData.ArtemisUpgrade.LinkedUpgrades.ExplosionTrait =
	{
		OneFromEachSet =
		{
			{ "HephaestusWeaponTrait", "HephaestusSecondaryTrait" },
	...
	-- HephaestusUpgrade
	table.insert(OlympusLootData.HephaestusUpgrade.PriorityPickupTextLineSets.HephaestusExpectingMiscOlympian01.RequiredMinAnyTextLines
		.TextLines, "HephaestusExpectingHephaestus01")
	table.insert(OlympusLootData.HephaestusUpgrade.PriorityPickupTextLineSets.HephaestusExpectingMiscOlympian01.RequiredFalseGodLoots
		, "HephaestusUpgrade")
	table.insert(OlympusLootData.HephaestusUpgrade.PriorityPickupTextLineSets.HephaestusExpectingMiscOlympian01.RequiredOneOfTraits
		, "ForceHephaestusBoonTrait")
	table.insert(OlympusLootData.HephaestusUpgrade.PriorityPickupTextLineSets.HephaestusExpectingMiscOlympian02.RequiredMinAnyTextLines
		.TextLines, "HephaestusExpectingHephaestus01")
	table.insert(OlympusLootData.HephaestusUpgrade.PriorityPickupTextLineSets.HephaestusExpectingMiscOlympian02.RequiredFalseGodLoots
		, "HephaestusUpgrade")
	table.insert(OlympusLootData.HephaestusUpgrade.PriorityPickupTextLineSets.HephaestusExpectingMiscOlympian02.RequiredOneOfTraits
		, "ForceHephaestusBoonTrait")
	table.insert(OlympusLootData.HephaestusUpgrade.PriorityPickupTextLineSets.HephaestusExpectingMiscOlympian03.RequiredMinAnyTextLines
		.TextLines, "HephaestusExpectingHephaestus01")
	table.insert(OlympusLootData.HephaestusUpgrade.PriorityPickupTextLineSets.HephaestusExpectingMiscOlympian03.RequiredFalseGodLoots
		, "HephaestusUpgrade")
	table.insert(OlympusLootData.HephaestusUpgrade.PriorityPickupTextLineSets.HephaestusExpectingMiscOlympian03.RequiredOneOfTraits
		, "ForceHephaestusBoonTrait")
	table.insert(OlympusLootData.HephaestusUpgrade.PriorityPickupTextLineSets.HephaestusExpectingMiscOlympian04.RequiredMinAnyTextLines
		.TextLines, "HephaestusExpectingHephaestus01")
	table.insert(OlympusLootData.HephaestusUpgrade.PriorityPickupTextLineSets.HephaestusExpectingMiscOlympian04.RequiredFalseGodLoots
		, "HephaestusUpgrade")
	table.insert(OlympusLootData.HephaestusUpgrade.PriorityPickupTextLineSets.HephaestusExpectingMiscOlympian04.RequiredOneOfTraits
		, "ForceHephaestusBoonTrait")
	table.insert(OlympusLootData.HephaestusUpgrade.PriorityPickupTextLineSets.HephaestusExpectingMiscOlympian05.RequiredMinAnyTextLines
		.TextLines, "HephaestusExpectingHephaestus01")
	table.insert(OlympusLootData.HephaestusUpgrade.PriorityPickupTextLineSets.HephaestusExpectingMiscOlympian05.RequiredFalseGodLoots
		, "HephaestusUpgrade")
	table.insert(OlympusLootData.HephaestusUpgrade.PriorityPickupTextLineSets.HephaestusExpectingMiscOlympian05.RequiredOneOfTraits
		, "ForceHephaestusBoonTrait")
	table.insert(OlympusLootData.HephaestusUpgrade.PriorityPickupTextLineSets.HephaestusExpectingMiscOlympian06.RequiredMinAnyTextLines
		.TextLines, "HephaestusExpectingHephaestus01")
	table.insert(OlympusLootData.HephaestusUpgrade.PriorityPickupTextLineSets.HephaestusExpectingMiscOlympian06.RequiredFalseGodLoots
		, "HephaestusUpgrade")
	table.insert(OlympusLootData.HephaestusUpgrade.PriorityPickupTextLineSets.HephaestusExpectingMiscOlympian06.RequiredOneOfTraits
		, "ForceHephaestusBoonTrait")

	OlympusLootData.HephaestusUpgrade.SuperPriorityPickupTextLineSets.HephaestusExpectingHephaestus01 =
	{
		PlayOnce = true,
		PreEventFunctionName = "BoonInteractPresentation", PreEventFunctionArgs = { PickupWait = 1.0, },
		MinRunsSinceSquelchedHephaestus = ConstantsData.SquelchedHephaestusRunCount,
		RequiredTextLines = { "HephaestusFirstPickUp" },
		RequiredFalseGodLoot = "HephaestusUpgrade",
		RequiredTrait = "ForceHephaestusBoonTrait",
		EndVoiceLines = GlobalVoiceLines.RushedHephaestusVoiceLines,

		{ Cue = "/VO/Hephaestus_0241",
			StartSound = "/Leftovers/World Sounds/MapZoomInShort", UseEventEndSound = true,
			Text = "Hi, boss. Hephaestus wanted to be here, but you know what they say: she had a fire to put out. Anyway, that blessing will still be warm!" },
	}

	-- Gift Section
	local OlympusGiftOrdering = ModUtil.Entangled.ModData(GiftOrdering)
	local OlympusGiftData = ModUtil.Entangled.ModData(GiftData)
	table.insert(OlympusGiftOrdering, 21, "ForceDaedalusTrait")
	...
	OlympusGiftData.HephaestusUpgrade =
	{
		...
		Maximum = 7,
		Locked = 7,
		[1] = { Gift = "ForceDaedalusTrait" },
		[7] = { RequiredResource = "SuperGiftPoints" },
		UnlockGameStateRequirements = { RequiredTextLines = { "HephaestusForgiveness03" } }
	}

	-- Multi Gods compatibility
	if ModUtil.Mods.Data["HephaestusExtra"] ~= nil and ModUtil.Mods.Data["ApolloExtra"] ~= nil then
        OlympusLootData.HephaestusUpgrade.LinkedUpgrades.ShoutMoreHealTrait =
        {
            OneFromEachSet =
            {
        ...
        OlympusLootData.HephaestusUpgrade.DuoPickupTextLineSets.HephaestusWithApollo01 = {
            Name = "HephaestusWithApollo01",
            PlayOnce = true,
            PreEventFunctionName = "BoonInteractPresentation", PreEventFunctionArgs = { PickupWait = 1.0, },
            ...
            { Cue = "/VO/Apollo_0300",
                ...
                Text = "Ah, Lady Hephaestus, nothing makes me more happy than helping our beloved Zagzag. But Artemis should have told me about him way earlier! Anyway, what's important is that we're here now." },
        }
        OlympusLootData.ApolloUpgrade.DuoPickupTextLineSets.ApolloWithHephaestus01 = {
            Name = "ApolloWithHephaestus01",
            PlayOnce = true,
            PreEventFunctionName = "BoonInteractPresentation", PreEventFunctionArgs = { PickupWait = 1.0, },
            HasTraitNameInRoom = "BlindAuraTrait",
            { Cue = "/VO/Apollo_0301",
        ...
        OlympusLootData.ApolloUpgrade.FreePassVoiceLines = {
            ApolloFreePass01 =
            {
                ...
                { Cue = "/VO/Apollo_0371",
                    PreLineFunctionName = "BoonInteractPresentation", PreLineWait = 1.0,
                    StartSound = "/Leftovers/World Sounds/MapZoomInShort", UseEventEndSound = true,
                    Text = "You think Lady Hephaestus is generous? Well, Zagzag, I'll show {#DialogueItalicFormat}you {#PreviousFormat}generosity. No fight this time, just blessings. I bet you'll think twice before you cross me again." },
            },
        }
    end
	...
	-- FUNCTIONS
	-- LastStand Hephaestus functions
	ModUtil.Path.Wrap("GiveLoot",
		function(baseFunc, args)
			if (args.ForceLootName == "HermesUpgrade") then
				args.ForceLootName = "HephaestusUpgrade"
				ModUtil.Hades.PrintStackChunks(ModUtil.ToString("HephaestusUpgrade"))
			end
	...
	table.insert(OlympusRoomSetData.Tartarus.RoomOpening.ForcedRewards, {
		...
		{
			RequiredTextLines = { "HermesUpgrade" },
			RequiredOnlyNotPickedUp = "HephaestusUpgrade",
