	...
	table.insert(OlympusCodexOrdering.Biomes.Order, "Gardens")

	OlympusCodex.Biomes.Entries["Gardens"] =
	{
		Entries =
		{
			{
				UnlockThreshold = 1,
				Text = "CodexData_Garden_01",
			},
			{
				UnlockThreshold = 20,
				Text = "CodexData_Garden_02",
			},
			{
				UnlockThreshold = 50,
				Text = "CodexData_Garden_03",
			},
		},
	...
	table.insert(OlympusRewardStoreData.InvalidOverrides,"Gardens")
	OlympusRewardStoreData.Gardens =
	{
		{
			Name = "GardenUpgrade",
		},
...
OverwriteTableKeys( RoomData, RoomSetData.Gardens )