...
if ModUtil ~= nil then
	...
	ModUtil.Table.Merge(OlympusKeywordList, { "Jealousy", "Snare", "Aura" })
	ResetKeywords()
	...
	OlympusTraitData.HeraShoutTrait =
	{
		...
		PreEquipWeapons = { "HeraMaxSuper", "HeraSuper" },
		PropertyChanges =
		{
	...
	OlympusLootData.HeraUpgrade = {
		...
		RequiredTextLines = { "ZeusFirstPickUp", "ApolloFirstPickUp", "HestiaFirstPickUp" },
		...
		WeaponUpgrades = { "HeraWeaponTrait", "HeraSecondaryTrait", "HeraRushTrait", "HeraRangedTrait",
			"HeraShoutTrait" },
		...
		LinkedUpgrades =
		{
			...
			JealousyBurstTrait = {
				OneOf = { "HeraRangedTrait", "HeraRevengeTrait", "LavaDeathTrait" },
			},
			JealousyCastTrait = {
				OneOf = { "HeraRangedTrait", "HeraRevengeTrait", "LavaDeathTrait" },
			},
			...
			BetterSnareTrait = {
				OneFromEachSet =
				{
					...
					{ "HeraRangedTrait", "HeraRevengeTrait", "LavaDeathTrait" },
				}
			},
			BetterJealousyTrait = {
				OneFromEachSet =
			...
			CurseLongerTrait =
			{
				OneFromEachSet =
				{
					{ "HeraWeaponTrait", "HeraSecondaryTrait", "HeraDashTrait", "HeraRangedTrait" },
	...
	OlympusLootData.AthenaUpgrade.DuoPickupTextLineSets.AthenaWithHera01 = {
		...
		{ Cue = "/VO/Athena_0251",
			StartSound = "/Leftovers/World Sounds/MapZoomInShort",
			Text = "Queen Hera. Make sure the fire you give to Zagreus doesn't burn him. That would be very conterproductive to our cause. I can only shield him so much." },
		{ Cue = "/VO/Hera_0051",
			PortraitExitWait = 0.35,
			PreLineFunctionName = "BoonInteractPresentation", PreLineWait = 0.5,
			StartSound = "/SFX/BurnDamage",
	...
	OlympusLootData.AresUpgrade.DuoPickupTextLineSets.AresWithHera01 = {
		...
		{ Cue = "/VO/Ares_0251",
			StartSound = "/Leftovers/World Sounds/MapZoomInShort",
			Text = "Queen Hera, are you going to let him fight with hugs and kisses? I think we can agree to give him something more." },
		{ Cue = "/VO/Hera_0052",
			PortraitExitWait = 0.35,
			PreLineFunctionName = "BoonInteractPresentation", PreLineWait = 0.5,
			StartSound = "/SFX/BurnDamage",
	...
	OlympusLootData.AphroditeUpgrade.DuoPickupTextLineSets.AphroditeWithHera01 = {
		...
		{ Cue = "/VO/Aphrodite_0241",
			StartSound = "/Leftovers/World Sounds/MapZoomInShort",
			Text = "Oh, Queen Hera. You are positively smoking hot, as always. I can't believe you've never taken up with any suitors! You don't know what you are missing." },
		{ Cue = "/VO/Hera_0053",
			PortraitExitWait = 0.35,
			PreLineFunctionName = "BoonInteractPresentation", PreLineWait = 0.5,
			StartSound = "/SFX/BurnDamage",
	...
	OlympusLootData.ArtemisUpgrade.DuoPickupTextLineSets.ArtemisWithHera01 = {
		...
		{ Cue = "/VO/Artemis_0261",
			StartSound = "/Leftovers/World Sounds/MapZoomInShort",
			Text = "Queen Hera, could you... give me the recipe once again for the smoky boar I made from the spoils of my hunt the other day? I'd like to hunt another, I think." },
		{ Cue = "/VO/Hera_0054",
			PortraitExitWait = 0.35,
			PreLineFunctionName = "BoonInteractPresentation", PreLineWait = 0.5,
			StartSound = "/SFX/BurnDamage",
	...
	OlympusLootData.DionysusUpgrade.DuoPickupTextLineSets.DionysusWithHera01 = {
		...
		{ Cue = "/VO/Dionysus_0241",
			StartSound = "/Leftovers/World Sounds/MapZoomInShort",
			Text = "Oh hey, Hera. I know I seem to party a lot, but I swear I am doing my part as an Olympian. You can ask the others." },
		{ Cue = "/VO/Hera_0055",
			PortraitExitWait = 0.35,
			PreLineFunctionName = "BoonInteractPresentation", PreLineWait = 0.5,
			StartSound = "/SFX/BurnDamage",
	...
	OlympusLootData.DionysusUpgrade.LinkedUpgrades.JealousyStacksTrait =
	{
		OneFromEachSet =
		{
			{ "HeraRangedTrait", "HeraRevengeTrait", "LavaDeathTrait" },
	...
	OlympusLootData.HestiaUpgrade.LinkedUpgrades.BossFriendsTrait =
	{
		OneFromEachSet =
		{
			{ "LastStandDamageReduceTrait", "HealthDefianceTrait", "HealthDamageTrait" },
