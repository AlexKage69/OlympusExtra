	...
	InteractTextLineSets =
	{
		NemesisFirstMeeting =
		{
			...
			{ Cue = "/VO/ZagreusHome_4000", Portrait = "Portrait_Zag_Serious_01", Speaker = "CharProtag",
				...
				Text = "Nemesis? How long has it been? Is my father making you work too much again? I haven't seen you of late." },
			{ Cue = "/VO/Nemesis_0001",
		...
		NemesisGift01 =
			{
				...
				{ Cue = "/VO/ZagreusHome_0118", Portrait = "Portrait_Zag_Serious_01", Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart", PreLineAnimTarget = "Hero",
					PostLineAnim = "ZagreusTalkEmpathy_Return", PostLineAnimTarget = "Hero",
					Text = "{#DialogueItalicFormat}Erm{#PreviousFormat}, Nemesis? You've done so much for me, I.. thought you might like this." },
				{ Cue = "/VO/Nemesis_0445",
...
--table.insert(OlympusDeathLoopData.DeathArea.StartUnthreadedEvents[17].Args.Types, "NPC_Nemesis_01")
...
OlympusGiftData.NPC_Nemesis_01 =
	{
		...
		MaxedRequirement = { RequiredTextLines = { "NemesisGift08" }, },
		Locked = 7,
		Maximum = 8,
